...
<div class="grid-container">
    <div class="left">
        ...
        <small class="uppercase">NEW LAB PHOTOGRAPHY SAS · Nit. 900.338.551-3</small>
    </div>
    <div class="right <?= count($formas_de_pago) >= 2 ? "noFixed" : "" ?>">
        <div class="resumen">
            <details open>
                <summary>
                ...
                <ul class="options">
                    <?php for ($i = 0; $i < count($formas_de_pago); $i++) {
                        ...
                        <li>
                            ...
                            <p class="discount">-<?= $forma_de_pago->descuento_adicional ?> %</p>
                            <p class="price">
                                <strong>
                                    <?php
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="212" height="25" viewBox="0 0 212 25" fill="none">
                                    <path d="M18.5965 13.6L8.18246 5.4L212 0L202.33 3.4L212 7.2L202.33 11.4L212 22.4L0 25L18.5965 13.6Z" fill="currentColor" />
                                </svg>
                            </p>
