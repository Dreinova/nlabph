...
<div class="grid-container">
    <div class="left">
        ...
        <div class="politics">
            ...
            <details open>
                <summary>CONDICIONES DE ALQUILER CONOCIDAS, ACEPTADAS Y ASUMIDAS POR EL CLIENTE <img
                        src="images/arrow.svg" alt="arrow"></summary>
                <div class="content">
    ...
    <div class="right <?=count($formas_de_pago) >= 2 ? "noFixed":""?>">
        <div class="resumen">
            <details open>
                <summary><h2>Resumen</h2> <img src="images/arrow.svg" alt="arrow"></summary>
                <div class="subtotal">
            ...
            <details open>
                ...
                <ul class="options">
                    <?php for ($i=0; $i < count($formas_de_pago); $i++) { $forma_de_pago = $formas_de_pago[$i]; ?>
                        <li>
